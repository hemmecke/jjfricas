...
requests_ library inside the wrapper kernel `fricaskernel.py`_. To
put it in a nutshell, jFriCAS essentially comprises three files
...
Cell input input in the Jupyter notebook is taken by
